...
public class SimplePaint implements Runnable {
    ...
    public void run() {
        ...
        final PaintPanel paint = new PaintPanel(QuadTreeKnotenImpl.buildFromIntArray(new int[512][512]));
        ...
        infoMenuItem.addActionListener(e -> JOptionPane.showMessageDialog(window,
                "Info:\n" + "Image Size: " + paint.getQuadTree().getDimension() + "x"
                        + paint.getQuadTree().getDimension() + "\n" + "Bytes: "
