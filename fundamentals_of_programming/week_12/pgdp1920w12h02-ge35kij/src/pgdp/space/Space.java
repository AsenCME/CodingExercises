...
public final class Space {
    ...
    public static void main(String[] args) {
        ...
        // Simple test
        // connections.put(gamma, List.of(new BeaconConnection(beta, NORMAL), new
        // BeaconConnection(gamma, NORMAL)));
        // connections.put(alpha, List.of(new BeaconConnection(gamma, WORMHOLE)));
