...
public class Order {
    ...
    public String toString() {
        return "Order{" + "orderKey=" + orderKey + ", custKey=" + custKey + ", orderStatus=" + orderStatus
                + ", totalPrice=" + totalPrice + ", orderDate=" + orderDate + ", orderPriority="
                + Arrays.toString(orderPriority) + ", clerk=" + Arrays.toString(clerk) + ", shippingPriority="
                + shippingPriority + ", comment=" + Arrays.toString(comment) + '}';
    }
